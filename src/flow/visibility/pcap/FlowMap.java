...
public class FlowMap
	 ...
	 */
	public FlowMap(int initialCapacity) {
	 ...
	 *          the m
	 */
	public FlowMap(Map<? extends JFlowKey, ? extends JFlow> m) {
		super(m);
	}
	 ...
	 *          the load factor
	 */
	public FlowMap(int initialCapacity, float loadFactor) {
